  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <img className={styles.background} src='background.webp' alt="Art generated by Artificial Intelligence and Hank Berger."/>
            ...
            <div className={styles.expContainer}>
              <div className={styles.expGrid} style={{marginTop: '0px'}}>
                ...
                <div className={styles.expDesc}>
                  <p>Software Developer on MyChart - Bedside. Focus on mobile development using Swift, Objective-C, Java, and React. Heavily involved in usability and user experience through the company.</p>
                </div>
              </div>
             <div className={styles.expGrid} style={{marginTop: '0px'}}>
                <div className={styles.expTitle}>
          ...
          <div className={styles.galleryContent}>
              ...
              <div className={styles.galleryGrid}>
                <Link href="/3d">
                  ...
                  <div className={styles.vidContainer} dangerouslySetInnerHTML={{__html: '<video src="/3Dsmall.mp4" muted autoPlay loop playsInline/>'}}></div>
