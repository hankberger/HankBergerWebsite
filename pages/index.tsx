  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <img className={styles.background} src='background.webp' alt="Background art for Hank Berger's portfilio website."/>
            ...
            <div className={styles.expContainer}>
              <div className={styles.expGrid} style={{marginTop: '0px'}}>
                ...
                <div className={styles.expDesc}>
                  <p>Software Developer on MyChart - Bedside. Focus on mobile/web development using Swift, Objective-C, Java, and React. Heavily involved in usability and user experience throughout the company.</p>
                </div>
              </div>
             <div className={styles.expGrid} style={{marginTop: '0px'}}>
                <div className={styles.expTitle}>
                  ...
                  <h3>
                    Digital Platform Engineering Intern
                  </h3>
                </div>
                <div className={styles.expDesc}>
                  <p>Intern on the Digital Platform Engineering Team. My main project was converting our public sites to React, and release management support using CI/CD tools such as Jenkins, Git, and AWS.</p>
                </div>
              </div>
              <div className={styles.expGrid} style={{marginTop: '0px'}}>
                <div className={styles.expTitle}>
                ...
                <div className={styles.expDesc}>
                  <p>Software Developer for CT Holdings, a parent company for small to medium sized businesses focused in manufacturing. Main focus was developing web applications to pull data into downloadable CSV files for customers.</p>
                </div>
              </div>
          ...
          <div className={styles.galleryContent}>
              ...
              <div className={styles.galleryGrid}>
                <Link href="/3d">
                  ...
                  <div className={styles.vidContainer} dangerouslySetInnerHTML={{__html: '<video src="/dance.mp4" muted autoPlay loop playsInline/>'}}></div>
        ...
        <div id='contact' className={styles.contact}>
          ...
          <div className={styles.copyright}>© 2023 Hank Berger. All rights reserved.</div>
        </div>
      </main>
